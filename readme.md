...
```bash
sudo curl https://raw.githubusercontent.com/ATheCoder/Namizun-Plus/master/else/setup.sh | sudo bash
```
...
```bash
git remote add origin https://github.com/ATheCoder/Namizun-Plus.git
```
